...
| `index_chunks()` / `search()` | Python 函数 | ✅ Day12（无 LLM） |
| RAG 问答 | 待 Day13 串联 | 🔜 |
...
- [Day01.md](Day01.md) ~ [Day12.md](Day12.md) — 每日工作日志

---

*文档版本：v0.2.0-rc | 最后更新：2026-07*
