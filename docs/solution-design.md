...
## 4. 当前方案（v0.2.0-alpha2）

### 4.1 模块职责

| 模块 | 文件 | 职责 |
|------|------|------|
| 配置层 | `app/core/config.py` | API、模型、上传/解析目录 |
...
Phase 2（v0.2）   企业知识库 RAG
      Day08✅ 上传 → Day09✅ 解析 → Day10~13 切分/向量/检索
      ↓
Phase 3           Agent + MCP
```
...
- [Day01.md](Day01.md) ~ [Day09.md](Day09.md) — 每日工作日志
